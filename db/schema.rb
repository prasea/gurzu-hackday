...
ActiveRecord::Schema[7.2].define(version: 2024_08_02_110950) do
  ...
  add_foreign_key "park_spaces", "users"
  add_foreign_key "park_vehicles", "park_spaces"
  add_foreign_key "vehicles", "park_spaces"
end
